...
export default function BanList({ page }: { page: number }) {
  ...
  return (
    <>
    <Head>
        <title>Khoá tài khoản | MineVN</title>
        <meta name="description" content="Tra cứu lịch sử khoá tài khoản tại MineVN" />
    </Head>
    <div className="content">
        ...
        <div className="card center" style={{maxWidth: '900px', marginTop: '20px'}}>
            ...
            <div style={{marginBottom: '16px'}}>
                <h3 style={{marginBottom: '0px'}}>Lịch sử khoá tài khoản</h3>
